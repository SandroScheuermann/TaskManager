...
namespace TaskManager.API.Mappings
{
    public static class UserMapping
    {
        ...
        private static async Task<IResult> GetUserAssignmentsReport(string managerUserId, string id, IMediator mediator)
        {
            var getCommand = new GetUserReportCommand { UserId = id, ManagerUserId = managerUserId };
